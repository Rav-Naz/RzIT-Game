        ...
        this.modal.showModal(SkanowanieComponent, {
            ...
            if (result === 'nfc') {
                ...
                this.dane.zbierzKlucz(result).then(res => {
                    if (res === 1) {
                        this.ui.pokazPowiadomienie('Sukces!', 'Znalazłeś nowy klucz', 0, 1.5)
                    }
                    else if (res === 2) {
                        this.ui.pokazPowiadomienie('Uwaga!', 'Już posiadasz ten klucz', 2, 1.5)
                    }
                    else if (res === 3) {
                        this.ui.pokazPowiadomienie('Uwaga!', 'Tego klucza nie ma w naszej bazie', 2, 1.5)
                    }
                    else {
